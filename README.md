...
# Solving [FlipFlop Codes 2025](https://flipflop.slome.org/2025/) in [jq 1.8.1](https://github.com/jqlang/jq/releases/tag/jq-1.8.1)
...
- Whether the input is interpreted and/or the output rendered as JSON or raw text depends on that puzzle's formatting of the input data and/or its expected result, and is declared explicitly in each file
